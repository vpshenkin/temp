...
function _getAssetData() {
  _getAssetData = _asyncToGenerator(function*(
    ...
    const fixedPath = assetPath.includes("node_modules") ? assetPath.substr(assetPath.indexOf("node_modules")) : localPath;
    let assetUrlPath = localPath.startsWith("..")
      ? publicPath.replace(/\/$/, "") + "/" + path.dirname(fixedPath)
      : path.join(publicPath, path.dirname(fixedPath)); // On Windows, change backslashes to slashes to get proper URL path from file path.
